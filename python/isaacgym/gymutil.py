...
def apply_random_samples(prop, og_prop, attr, attr_randomization_params, randomization_ct):
    if isinstance(prop, gymapi.SimParams):
        ...
        sample = generate_random_samples(attr_randomization_params, prop[attr].shape, randomization_ct)
        if attr_randomization_params['operation'] == 'scaling':
        ...
        sample = generate_random_samples(attr_randomization_params, 1, randomization_ct)
