...
while True:
    ...
    if frame_count == 1:
        ...
        # if args.headless:
        #     break
    color_image = gym.get_camera_image(sim, env, cam_handles[0], gymapi.IMAGE_COLOR)
    # print(color_image.shape)
    # plt.imshow(color_image)
    # plt.show()
    gym.write_camera_image_to_file(sim,env,cam_handles[0], gymapi.IMAGE_COLOR, "test_image.png")
