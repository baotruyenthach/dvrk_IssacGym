...
if sim_type is gymapi.SIM_FLEX:
    ...
    sim_params.flex.num_inner_iterations = 30
    sim_params.flex.relaxation = 0.2
    sim_params.flex.warm_start = 0.2
...
asset_root = "../../assets"
soft_asset_file = "urdf/new_icosphere_1.urdf"

soft_pose = gymapi.Transform()
soft_pose.p = gymapi.Vec3(0, 3, 0.5)
...
while not gym.query_viewer_has_closed(viewer):
    ...
    move_daVinci_end_effector(0.0, 0.5, 0.3, gymapi.Quat(0,0,0,1),0)
    move_gripper(0)
