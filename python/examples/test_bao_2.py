...
#franka_asset_file = "urdf/kinova_description/urdf/kinova.urdf"
#franka_asset_file = "urdf/kuka_allegro_description/kuka_allegro.urdf"
#franka_asset_file = "urdf/daVinci_description/robots/psm_from_WPI_test_2.urdf"  # change
franka_asset_file = "urdf/daVinci_description/robots/new_psm_new_gripper.urdf"
...
#franka_hand_index = franka_link_dict["kinova_end_effector"]
#franka_hand_index = franka_link_dict["psm_tool_roll_link"]  #change
...
franka_pose.p = gymapi.Vec3(0, 0, 0.2)
...
#    table_handle = gym.create_actor(env, table_asset, table_pose, "table", i, 0)
    ...
    gym.set_joint_target_position(envs[0], gym.get_joint_handle(envs[0], "franka", "psm_yaw_joint"), 0.785)
    # gym.set_joint_target_position(envs[0], gym.get_joint_handle(envs[0], "franka", "psm_pitch_back_joint"), -0.785)
    # gym.set_joint_target_position(envs[0], gym.get_joint_handle(envs[0], "franka", "psm_main_insertion_joint"), 0.0)
...
while not gym.query_viewer_has_closed(viewer):
    ...
    if (t >= start_time):    
        gym.set_joint_target_position(envs[0], gym.get_joint_handle(envs[0], "franka", "psm_yaw_joint"), -1.5994)
        gym.set_joint_target_position(envs[0], gym.get_joint_handle(envs[0], "franka", "psm_pitch_back_joint"), 0.94249)
        gym.set_joint_target_position(envs[0], gym.get_joint_handle(envs[0], "franka", "psm_main_insertion_joint"), 0.24)
        gym.set_joint_target_position(envs[0], gym.get_joint_handle(envs[0], "franka", "psm_tool_roll_joint"), 3.14159)
        gym.set_joint_target_position(envs[0], gym.get_joint_handle(envs[0], "franka", "psm_tool_pitch_joint"), 1.5708)
        gym.set_joint_target_position(envs[0], gym.get_joint_handle(envs[0], "franka", "psm_tool_yaw_joint"), 0.785)
