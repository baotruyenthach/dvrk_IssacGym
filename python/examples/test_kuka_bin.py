...
bin_pose.r = gymapi.Quat(0, 0.0, 0.0, 1)
...
#        attractor_properties.target.p.y -= 0.15
        ...
        attractor_properties.target.p = gymapi.Vec3(0.07, 0.01, 0)
        attractor_properties.target.r = gymapi.Quat(-0.707107, 0.0, 0.0, 0.707107)
#        print(attractor_properties.target)
...
#                attr_pose.p.y = 0.01 
#                attr_pose.p.z = 0.02
            attr_pose.r = gymapi.Quat(-0.707107, 0.0, 0.0, 0.707107)
